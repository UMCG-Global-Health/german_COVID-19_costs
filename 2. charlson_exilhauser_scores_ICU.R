...
df <- read.csv("./data/GUF_cleaned_ICU.csv")
colnames(df)[1] <- "id"
df_copy <- df
...
write.csv(df_final,"./data/df_final_ICU.csv")


write.csv(elixhauser_copy, "./data/elixahauser_ICU.csv")

write.csv(charlson, "./data/charlson_ICU.csv")
